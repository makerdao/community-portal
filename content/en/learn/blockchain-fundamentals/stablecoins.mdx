...
Operating a business with thin margins, for example, can be neary impossible when the underlying currency is so volatile.

Unlike Bitcoin and Ether, the value of a stablecoin is pegged to an underlying asset like the US Dollar. The goal of is to maintain a stable value relative to its underlying asset.
