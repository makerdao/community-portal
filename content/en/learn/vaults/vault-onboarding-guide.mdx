...
Select a collateral type for this Vault. Make note of the information about the [Stability Fee](/learn/vaults/stability-fees/), [Liquidation Ratio](/learn/vaults/liquidiation/#liquidation-ratio), and [Liquidation Penalty](/learn/vaults/liquidation/#liquidation-penalty). These are important risk parameters which you should understand as well as be able to apply to your specific situation. When ready, click “Continue.”
