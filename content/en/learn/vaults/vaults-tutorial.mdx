...
Vaults are required to be overcollateralized and have a [Liquidation Ratio](liquidation.mdx#liquidation_ratio) that Vault owners need to uphold to avoid the Liquidation of their positions.
...
The [Stability Fee](stability-fee.mdx) is a variable-rate fee continuously added to a Vault owner’s generated Dai balance.
...
![Imgur](https://i.imgur.com/QM63vjM.png)
![Emergency Shutdown Module](./.png)
