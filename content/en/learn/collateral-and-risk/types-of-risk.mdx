...
Exogenous risk refers to additional risks associated with variables like oracles and governance. 

Consider, oracle attacks, or the presumed susceptibility of the collateral price feeds. 

To what extent can an attacker siphon value from the system if they were to subvert the price feeds? 

What would the appropriate countermeasures be in such a scenario? 
