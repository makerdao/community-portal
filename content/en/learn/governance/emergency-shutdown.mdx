...
This can be achieved using Vault frontends like [Oasis Borrow](https://oasis.app/borrow) that have Emergency Shutdown support implemented as well as via the command-line.
...
For technical information about the Shutdown of the Maker Protocol, please see the [Emergency Shutdown Module Documentation](https://docs.makerdao.com/smart-contract-modules/emergency-shutdown-module).
