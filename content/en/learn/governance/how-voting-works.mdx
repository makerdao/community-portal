...
Voting requires [Maker (MKR) tokens](https://community-development.makerdao.com/makerdao-mcd-faqs/faqs/mkr-token) and takes place in the [Governance Portal](https://vote.makerdao.com/).
