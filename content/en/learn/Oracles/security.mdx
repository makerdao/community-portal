...
description: "How the Oracle system is made secure"
---
...
This allows [MKR token](/learn/governance/mkrtokens.mdx) holders and other stakeholders the time to react to bugs or attacks on the Oracles. An OSM is active on each Oracle in the Maker Protocol.
