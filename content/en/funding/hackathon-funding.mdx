...
Demonstrated access to talent and hackathon attendees \(via chat, forum, Github, etc.\)

Themes focusing on governance, risk management, stability, and derivatives, and/or privacy tooling.
...
If your hackathon meets all the above criteria, please fill out this brief application.

<Aligner center>

<Button>Fill out an Application</Button>
...
or participate as judges, speakers, and mentors. 

Ask us about this in our chat.

<Aligner center>

<Button to="https://chat.makerdao.com/channel/community-development"
  icon="rocketchat"
>
  Community chat
</Button>
