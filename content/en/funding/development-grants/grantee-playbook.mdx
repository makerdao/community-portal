...
Grantee funds are released upon the completion of predetermined milestones. To the following to ensure your next block of allocated funds:

* Follow this framework and other requirements docs sent from the team.
* Keep up your [code repo active.](grantee-playbook.md#code-repo-activity)
* Complete your roadmap items and show progress via commits or issues.
* Hit milestones on time\(ish\).
* Document your activity with [regular development posts.](grantee-playbook.md#regular-dev-posts)
* Build a [social media presence.](grantee-playbook.md#social-media-presence)
* Get to know and help out other grantees. Join and post regularly in the [grantee chat.](grantee-playbook.md#post-regularly-in-chat-makerdao-com)
...
{% embed url="https://twitter.com/sablierhq?lang=en" %}
