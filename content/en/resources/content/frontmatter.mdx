...
and put it on the top level of the sidebar. For example, `/contribute/bounties/test.mdx` with an order of 0 will
just appear at the top of the `bounties` dropdown in the sidenav and not at the top of the `contribute` sidenav.
