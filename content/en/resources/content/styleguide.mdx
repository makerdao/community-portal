...
keywords: "style, guide, design, help, technical, components"
...
For a broader overview of all components, check out the [Component Palette](/work_with_us/content/palette-recipes). For more information about using components in MDX, read our other tutorials on [Crafting Technical Content](/develop/content).
