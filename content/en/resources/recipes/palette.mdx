...
- This palette is primarily to showcase component usage in a vacuum. See the [Frankenstein page](/resources/frankenstein) for advanced usages. 

- For an in-depth on props available for these components please see the [Cheatsheet](/resources/content/cheatsheet)
...
```js
<Button to="/"> ET go Home </Button>

<Button secondary inline to="/resources/palette"> Inlined Secondary </Button>

<Button outline to="/resources/palette"> Click Here </Button>

<Button small to="/resources/palette"> Small Button </Button>
...
<Button disabled inline to="/resources/palette"> Disabled Inline </Button>
