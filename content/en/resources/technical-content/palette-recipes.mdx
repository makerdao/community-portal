...
- This palette is primarily to showcase component usage in a vacuum. See the [Advanced page](/resources/content/advanced/) for deeper use cases.

- For an in-depth page on props available for these components please see the [Cheatsheet](/resources/content/cheatsheet)
...
<Button text to="/"> Text Button </Button>

<Button text disabled to="/"> Disabled Text Button </Button>
