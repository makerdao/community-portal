...
* [Learn how the protocol is managed through governance.](/work_with_us/governance_and_risk_meetings/)
...
* [Organize Meetups](/work_with_us/meetups/)
* [Improve Meetup Guides](/work_with_us/meetups/)
* [Translate MakerDAO Resources](/work_with_us/)
* [Write Risk & Governance Meeting Summaries](/work_with_us/governance_and_risk_meetings/summaries/)
* [Curate Awesome-MakerDAO](https://github.com/makerdao/awesome-makerdao)
* [Participate in a Hackathon](/work_with_us/hackathons/)
...
* Writers should be well versed with the [Writing Style Guide.](/work_with_us/content/writing-style-guide/)
...
* Reviewers should be well versed with the [Reviewer](/work_with_us/content/reviewer-guide/) and [Writing Style](/work_with_us/content/writing-style-guide/) Guides.
...
* Numbers after the decimal (V0.1, V1.4), outline the draft versions within a version.
    ...
    * For more best practices, follow the [Contributor Tools Guide](/work_with_us/content/contributor-tools/).
...
* [Contributor Tools Guide](/work_with_us/content/contributor-tools/): Introduces the tools regularly used for developing and maintaining Comm-Dev resources.
* [Writing Style Guide](/work_with_us/content/writing-style-guide/): Outlines Comm-Dev writing standards of tone and grammar.
* [Reviewer Guide](/work_with_us/content/reviewer-guide/): Introduces the review process and outlines editing standards.
* [Earn as a Contributor](/work_with_us/): Lists the different ways to earn Dai for contributions.
...
* [Visual Style Guide](/work_with_us/content/): Presents the Comm-Dev visual standards.
* [Governance and Risk Summary Guide](/work_with_us/governance_and_risk_meetings/summaries/): Outlines instructions for producing Risk and Governance meeting call summaries.
...
* Be comfortable working with Google Docs, Markdown on HackMD, and GitHub. Refer to the [Contributor Tools Guide](/work_with_us/content/contributor-tools/) for best practices.
