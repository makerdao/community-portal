...
<CTA>
  <Icon name="search" /> Make sure to express interest in the chat before
  working on a bounty.{" "}
...
<CTA Icon name="search">
  
  If the work is content-based, it will have to be copied
  from a Google Doc to markdown. All content on the site is in markdown. Use
  Hack.md to create markdown content.
