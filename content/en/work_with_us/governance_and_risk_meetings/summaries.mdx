...
The *most* critical part of these summaries is accuracy, readability, and intuitive formating.
...
In standardizing the rules around contributing, the community maintains a [Writing Style Guide](/en/work_with_us/content/writing-style-guide/) that contains all the rules for consistent language, grammar, and formatting. Below are the rules most relevant to these summaries:

- Please follow the [Naming Convention Guidelines](/work_with_us/content/writing-style-guide/) found in the writing style guide.
...
- Consult the [Writing Style Guide](/en/work_with_us/content/writing-style-guide/) and [Reviewer Guides](/work_with_us/content/reviewer-guide/) for additional information.
...
- Use a Linter in VSCode to find formatting errors. For more information on linters, see the [Contributor Tools Guide.](/work_with_us/content/common-tools/)
