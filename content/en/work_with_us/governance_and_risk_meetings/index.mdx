...
Public meetings are now password protected. Reach out to an admin in the general chat to request the password. 

<Link to={"https://chat.makerdao.com/channel/general"} icon={"rocketchat"}> General chat. </Link>	
...
<Link to={"https://chat.makerdao.com/channel/community-development"} icon={"rocketchat"}>
