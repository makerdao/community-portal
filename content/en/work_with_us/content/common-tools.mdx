...
Before starting work on a Community Development project, contributors are encouraged to study MakerDAO’s [contributor resources](/work_with_us/content/).
...
<Callout icon="checkmark" secondary>
<Box>
Pro Tips:
