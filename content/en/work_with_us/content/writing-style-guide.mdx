...
In addition to this guide, Writers are encouraged to study the [contributor resources](/work_with_us/content/) before starting work on a Community Development project.

- [Contributor Onboarding Guide](/work_with_us/content/contributor-onboarding-guide/)
- [Contributor Tools Guide](/work_with_us/content/common-tools/)
- [Reviewer Guide](/work_with_us/content/reviewer-guide/)
...
- Create descriptive hyperlinks and avoid generic language.
  ...
  - **Generic:** Learn more [here.](/work_with_us/content/)
...
Review the [contributor resources](/work_with_us/content/) before starting work on any MakerDAO Community Development project.

- Comm-Dev contributor guides outline writing standards and help simplify the writing process.

#### Contributor Onboarding Guide

- The [Contributor Onboarding Guide](/work_with_us/onboarding/) introduces the process for contributing to MakerDAO’s Community Development resources.
...
- The [Contributor Tools Guide](/work_with_us/content/common-tools/) guide introduces the tools regularly used by Community Development.
