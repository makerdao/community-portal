...
<Callout variant="warning" icon="github">
...
<Button to="/work_with_us/content/using-github-one-off/">One-off guide</Button>
...
<Button to="/work_with_us/content/using-github-ongoing/">In-depth guide</Button>
