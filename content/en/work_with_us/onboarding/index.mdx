...
* Numbers after the decimal (V0.1, V1.4), outline the draft versions within a version.
    ...
    * For more best practices, follow the [Contributor Tools Guide](/work_with_us/content/common-tools/).
...
* [Contributor Tools Guide](/work_with_us/content/common-tools/): Introduces the tools regularly used for developing and maintaining Comm-Dev resources.
...
* Be comfortable working with Google Docs, Markdown on HackMD, and GitHub. Refer to the [Contributor Tools Guide](/work_with_us/content/common-tools/) for best practices.
