...
const Video = ({src, title}) => (
	<Box sx={{pb: '50%', position: 'relative', height: 0, overflow: 'hidden'}}>
		<Box>
			<iframe src={src} title={title || 'Inlined Iframe Video'} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen sx={{border: 0, position: 'absolute', top: 0, left: 0, width: '100%', height: '100%'}}></iframe>
		</Box>
	</Box>
)
